...
class Player(QWidget):
    ...
    def open(self):
        ...
        self.addToPlaylist("rtsp://127.0.0.1:5554/user=user&password=&channel=1&stream=1.sdp?real_stream")
    ...
    def addToPlaylist(self, fileNames):
        ...
        #         url = QUrl(name)
        #         if url.isValid():
        self.playlist.addMedia(QMediaContent("rtsp://127.0.0.1:5554/user=user&password=&channel=1&stream=1.sdp?real_stream"))
